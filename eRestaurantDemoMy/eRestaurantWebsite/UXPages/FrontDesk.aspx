...
<%@ Register Src="~/User Control/DataTimeMocker.ascx" TagPrefix="uc1" TagName="DataTimeMocker" %>



<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc1:DataTimeMocker runat="server" ID="Mocker" />
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Panel ID="OccupiedTablePanel" runat="server"
                                ...
                                <asp:HyperLink ID ="ServerTableLink" runat="server"
                                    NavigateUrl ='<%# string.Format("~/UXPages/ServingTables.aspx?waiter={0}&bill{1}&md={2}&mt={3}&mds={4}&mts={5}",Item.Waiter,Item.BillID,Mocker.MockDate.Ticks,
                                    Mocker.MockTime.Ticks,
                                    Mocker.MockDate.ToShortDataString(),
                                    Mocker.MockTime.ToString()) %>'></asp:HyperLink>
                                <%# Item.Waiter %>
    ...
    <asp:ObjectDataSource runat="server" ID="SeatingObjectDataSource" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="Mocker" PropertyName="MockerTime" DbType="Time" Name="newtime"></asp:ControlParameter>
        </SelectParameters>
        ...
        <details open>
            ...
            <asp:Repeater ID="ReservationsRepeater" runat="server"
                        ...
                        <asp:ListView ID="ReservationSummaryListView" runat="server"
                            ...
                            <ItemTemplate>
                                <div>
                                    ...
                                    <%# Item.Contact %>
                                    <asp:LinkButton 
                                        ID ="SeatingReservation" runat="server"
                                        CommandName="Seat"
                                        CommandArgument='<%# Item.ID %>'>Reservation Seating <span class ="glyphicon glyphicon-plus"></span> 
                                    </asp:LinkButton>
                                </div>
                            </ItemTemplate>
                        </asp:ListView>
               ...
               <!--this panel will display the waiter drop down list
                and the multi-line control for selecting waiter and 
                table for reservation seating-->
            ...
            <asp:DropDownList ID="WaiterDropDownList" runat="server" CssClass="seating"
             ...
             </asp:ListBox><asp:ObjectDataSource ID="AvailableSeatingObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="AvailableSeatingByDateTime" TypeName="eRestaurantSystem.BLL.AdminController">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="Mocker" Name="date" PropertyName="MockDate" Type="DateTime" />
                        <asp:ControlParameter ControlID="Mocker" DbType="Time" Name="time" PropertyName="MockerTime" />
                    </SelectParameters>
                </asp:ObjectDataSource>
             </asp:Panel>
